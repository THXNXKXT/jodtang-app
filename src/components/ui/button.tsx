...
const variantClasses: Record<ButtonVariant, string> = {
  ...
  secondary:
    "border border-[var(--color-border)] bg-[var(--color-surface-hover)] text-[var(--color-text-primary)] hover:bg-[var(--color-surface)]",
  ghost:
    "bg-transparent text-[var(--color-text-secondary)] hover:bg-[var(--color-surface-hover)] hover:text-[var(--color-text-primary)]",
};

/**
 * Motion-enabled button with a tactile `whileTap` scale and three variants.
 */
