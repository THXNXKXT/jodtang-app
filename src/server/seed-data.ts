...
export const defaultCategories = [
  ...
  { name: "ค่าเช่า", nameEn: "Rent", type: "expense" as const, icon: "rent", color: "#0891b2", sortOrder: 9 },
  { name: "กาแฟ", nameEn: "Coffee", type: "expense" as const, icon: "coffee", color: "#92400e", sortOrder: 10 },
  { name: "สัตว์เลี้ยง", nameEn: "Pet", type: "expense" as const, icon: "pet", color: "#7c3aed", sortOrder: 11 },
  { name: "ซ่อมบำรุง", nameEn: "Repair", type: "expense" as const, icon: "repair", color: "#78716c", sortOrder: 12 },
...
export const defaultCatNames = defaultCategories.map(c => c.name);
